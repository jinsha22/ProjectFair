...
function Add() {
  ...
  return (
    <>
      <button  onClick={handleShow}  style={{ textDecoration: 'none' }} className='btn btn-link  text-warning d-flex align-center fw-bolder'> <i style={{ height: '34px' }} className='fa-solid fa-plus fa-2x me-2'> </i>Add Project</button>
        ...
        <Modal.Body>
          ...
          <div className='col-lg-6'>
            <label>
              ...
              <img height={'250px'} width={'250px'}  className='mt-5 text-center' src={ub} alt="project upload pic" />
